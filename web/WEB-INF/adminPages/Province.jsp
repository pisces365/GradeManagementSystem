        ...
        <div class="card-body">
            ...
            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                <table class="table my-0" id="dataTable">
                    ...
                    <tbody>
                    <tr>
                        <td><input class="form-control" type="text" name="yjn_PnoProvince02" ></td>
                        <td><input class="form-control" type="text" name="yjn_PnameProvince02" ></td>
        ...
        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
            <form action="AdminUpdateAndDelete.do" method="post" id="myForm">
                ...
                <table class="table my-0" id="dataTable">
                    ...
                    <tr>
                        <input class="form-control" type="hidden" id="yjn_PnoProvince02<%=i%>" name="yjn_PnoProvince02<%=i%>" value="<%= coD.getYjn_Pno02()%>" readOnly="true">

                        <td ><%= coD.getYjn_Pno02()%></td>
                        <td><input class="form-control" type="text" id="yjn_PnameProvince02<%=i%>" name="yjn_PnameProvince02<%=i%>" value="<%= coD.getYjn_Pname02()%>"></td>
                        ...
                        <script>
                            function submitFun<%=i%>(act)
                            {
                                ...
                                document.getElementById("yjn_PnoProvince02").value = document.getElementById("yjn_PnoProvince02<%=i%>").value;
                                document.getElementById("yjn_PnameProvince02").value = document.getElementById("yjn_PnameProvince02<%=i%>").value;
                ...
                <input class="form-control" type="hidden" id="yjn_PnoProvince02" name="yjn_PnoProvince02"  readOnly="true">
                <input class="form-control" type="hidden" id="yjn_PnameProvince02" name="yjn_PnameProvince02" >
