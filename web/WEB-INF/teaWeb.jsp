                ...
                <div class="sidebar-category sidebar-default"
                    ...
                    <div class="category-content" style=" background-color: rgb(234,245,254);">
                        <ul id="fruits-nav" class="nav flex-column">
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/LogIn.do" id="myPage_Button" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="#other-fruits1" class="nav-link" data-toggle="collapse" role="button"
                                   aria-expanded="false" aria-controls="other-fruits1">
                                    <b class=" " aria-hidden="true">🔵</b> 学生排名管理
                                </a>
                                <ul id="other-fruits1" class="flex-column collapse">
                                    <li class="nav-item">
                                        <a href="/YangjnGradeManagementSystem02_war_exploded/CoursesPlace.do" id="table_college_Button" class="nav-link">
                                            <b class=" " aria-hidden="true">🔵</b> 课程排名概览
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/YangjnGradeManagementSystem02_war_exploded/ClassesPlace.do" id="table_major_Button" class="nav-link">
                                            <b class=" " aria-hidden="true">🔵</b> 班级排名概览
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/YangjnGradeManagementSystem02_war_exploded/MajorsPlace.do" id="table_class_Button" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/AvgScoreCount.do" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 课程平均成绩查询
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/ScoreUpload.do" id="fillTable_Button" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 成绩录入
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/TeachersCourses.do" id="QRcode_Button" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 教师任课查询
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/StuLocation.do" id="QRcode_Button" class="nav-link">
