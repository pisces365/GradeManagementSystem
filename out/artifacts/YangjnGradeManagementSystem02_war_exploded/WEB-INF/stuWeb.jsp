                ...
                <div class="sidebar-category sidebar-default"
                    ...
                    <div class="category-content" style=" background-color: rgb(234,245,254);">
                        <ul id="fruits-nav" class="nav flex-column">
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/LogIn.do" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 我的主页
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/stuGrade.do" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 学生成绩查询
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/CoursesAndCredits.do" id="fillTable_Button" class="nav-link">
                                    <b class=" " aria-hidden="true">🔵</b> 在修课程与学分统计
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/YangjnGradeManagementSystem02_war_exploded/stuClassesCourses.do" id="QRcode_Button" class="nav-link">
